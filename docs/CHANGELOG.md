...
> Ultimo consolidamento `B2`: freeze esplicito renderer-side del delta tra golden non-golden e golden baseline, limitato ai soli token derivati attesi dell'apex (`apex_fqdn` e `apex_slug`) e privo di derive strutturali residue.
