...
> Ultimo consolidamento `B2`: freeze esplicito application-side del success-call contract sul percorso non-golden, così che il boundary `application` risulti difeso anche sulla corretta orchestrazione verso il renderer e non solo sul risultato strutturato finale.
