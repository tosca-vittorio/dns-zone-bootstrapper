...
def test_render_bind_zone_file_returns_expected_public_safe_text() -> None:
    ...
    expected = "\n".join(
        (
            ...
            (
                "autodiscover.testdomain.com. 1 IN CNAME "
                "__FIXED_MAIL_HOST__. ; cf_tags=cf-proxied:false"
            ),
            (
                "brevo1._domainkey.testdomain.com. 1 IN CNAME "
                "b1.testdomain-com.dkim.__FIXED_PROVIDER_ZONE__. ; cf_tags=cf-proxied:false"
            ),
            (
                "brevo2._domainkey.testdomain.com. 1 IN CNAME "
                "b2.testdomain-com.dkim.__FIXED_PROVIDER_ZONE__. ; cf_tags=cf-proxied:false"
            ),
            (
                "www.testdomain.com. 1 IN CNAME "
                "testdomain.com. ; cf_tags=cf-proxied:true"
            ),
            "",
            ";; MX Records",
            ...
            "",
            ";; SRV Records",
            "_autodiscover._tcp.testdomain.com. 1 IN SRV 0 1 443 __FIXED_MAIL_HOST__.",
            "",
            ";; TXT Records",
            (
            ...
            (
                '_dmarc.testdomain.com. 1 IN TXT '
                '"v=DMARC1; p=none; rua=mailto:__FIXED_DMARC_RUA__"'
            ),
            '_domainkey.testdomain.com. 1 IN TXT "t=y; o=~;"',
            (
